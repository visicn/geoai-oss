/// <summary>
/// TableExtension Vendor GeoAI (ID 70011) extends Record Vendor.
/// Adds geolocation fields to Vendor table.
/// </summary>
tableextension 70011 "Vendor GeoAI" extends Vendor
{
    fields
    {
    ...
    /// <summary>
    /// Geocodes the vendor address and updates coordinates.
    /// </summary>
