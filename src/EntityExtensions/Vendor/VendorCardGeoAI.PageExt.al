/// <summary>
/// PageExtension Vendor Card GeoAI (ID 70052) extends Page Vendor Card.
/// Adds GeoAI fields and actions to Vendor Card page.
/// </summary>
pageextension 70052 "Vendor Card GeoAI" extends "Vendor Card"
{
    layout
    {
        addlast(content)
        {
            group("GeoAI")
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the latitude coordinate of the vendor address.';
                }
                field("GeoAI Longitude"; Rec."GeoAI Longitude")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the longitude coordinate of the vendor address.';
                }
        ...
        addlast(navigation)
        {
            group(GeoAIActions)
            {
                ...
                action(GeocodeAddress)
                {
                    ...
                    ToolTip = 'Geocodes the vendor address to get coordinates.';
                    Image = MapSetup;
                ...
                action(ViewOnMap)
                {
                    ApplicationArea = All;
                    Caption = 'View on Map';
                    ToolTip = 'Opens the vendor location in an external mapping service.';
                    Image = Map;
                ...
                action(AskGeoAI)
                {
                    ApplicationArea = All;
                    Caption = 'Ask GeoAI...';
                    ToolTip = 'Opens GeoAI prompt copilot for this vendor.';
                    Image = Sparkle;
